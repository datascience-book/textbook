...
- One of the best parts of R is the vibrant and (generally) helpful online community...
- More often than not, Stack Overflow will contain an answer, but it might not necessarily be to your question
- User beware: R coders looking for an answer may copy and paste code from Stack Overflow without check what it does precisely. This may lead to unintended problems
