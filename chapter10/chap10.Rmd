...
_3. Tune k_. The KNN technique is sensitive to the value of $k$ and the voting kernel, requiring tuning -- or testing different values of $k$. When $k = 10$ with a rectangular kernel, the conditional probability for $y_i$ reflects the 10-nearest neighbors. When $k = n$, the conditional probability is equivalent to the sample mean. 
