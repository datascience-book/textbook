...
Flavors of feature engineering
Feature engineering is important but expensive due to the time cost
...
Clean up dates 
For each record
we’ll calculate a number of additional variables on a 90 day moving window
